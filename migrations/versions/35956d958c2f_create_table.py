...
Revision ID: 35956d958c2f
Revises: 
Create Date: 2025-06-05 09:59:32.376473
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('PENDING', 'APPROVED', 'REJECTED', 'COMPLETED', name='bookingstatus'), nullable=True),
